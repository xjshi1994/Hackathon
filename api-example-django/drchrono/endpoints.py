...
class PatientEndpoint(BaseEndpoint):
    ...
    def list(self, params=None, first_name=None, last_name=None, date_of_birth=None, **kwargs):
        """
        ...
        if 'first_name' not in params or 'last_name' not in params or 'date_of_birth' not in params:
            raise Exception("Must provide first name, last name and date_of_birth")
